document.addEventListener("DOMContentLoaded", function () {
  ...
  let hasilSatu = document.querySelector("#hasil");
  ...
  function loadSoalSatu() {
    ...
    xhttp.open("GET", "../../json/latihan_kuartil.json", true);
    xhttp.send();
  } 
  ...
  cekSatu.addEventListener("click", function () {
    ...
    if (answerSatu.value != jawabanSatuA) {
      answerSatu.style.border = "2px solid red"
      hasilSatu.style = "color:red;font-weight:bold"
      hasilSatu.innerHTML = `
        ${
          answerSatu.value !== ""
      ...
      hasilSatu.style = "color:green;font-weight:bold"
      hasilSatu.innerHTML = `
          hasil! Jawabannya adalah <strong>${jawaban}</strong>.
      `;
  ...
  let hasilDua = document.querySelector("#hasil2");
  ...
  cekDua.addEventListener("click", function () {
    ...
    if (answerDua.value != jawabanDua) {
      ...
      hasilDua.style = "color:red;font-weight:bold"
      hasilDua.innerHTML = `
        ${
          answerDua.value !== ""
      ...
      hasilDua.style = "color:green;font-weight:bold"
      hasilDua.innerHTML = `
          hasil! Jawabannya adalah <strong>${jawabanDua}</strong>.
      `;
  ...
  let hasilTiga = document.querySelector("#hasil3");
  ...
  cekTiga.addEventListener("click", function () {
    ...
    if (answerTiga.value != jawabanTiga) {
      ...
      hasilTiga.style = "color:red;font-weight:bold"
      hasilTiga.innerHTML = `
        ${
          answerTiga.value !== ""
      ...
      hasilTiga.style = "color:green;font-weight:bold"
      hasilTiga.innerHTML = `
          hasil! Jawabannya adalah <strong>${jawabanTiga}</strong>.
      `;
  ...
  let hasilEmpat = document.querySelector("#hasil4");
  ...
  cekEmpat.addEventListener("click", function () {
    ...
    if (answerEmpat.value != jawabanEmpat) {
      ...
      hasilEmpat.style = "color:red;font-weight:bold"
      hasilEmpat.innerHTML = `
        ${
          answerEmpat.value !== ""
      ...
      hasilEmpat.style = "color:green;font-weight:bold"
      hasilEmpat.innerHTML = `
          hasil! Jawabannya adalah <strong>${jawabanEmpat}</strong>.
      `;
  ...
  let hasilLima = document.querySelector("#hasil5");
  ...
  cekLima.addEventListener("click", function () {
    ...
    if (answerLima.value != jawabanLima) {
      ...
      hasilLima.style = "color:red;font-weight:bold"
      hasilLima.innerHTML = `
        ${
          answerLima.value !== ""
      ...
      hasilLima.style = "color:green;font-weight:bold"
      hasilLima.innerHTML = `
          hasil! Jawabannya adalah <strong>${jawabanLima}</strong>.
      `;
