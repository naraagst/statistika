document.querySelector(".sidebar").innerHTML = `
			<ul>
				...
				<li class="dropdown1">
					<a href=javascript:void(0) class="dropbtn" id="materiA" onclick="dropdown6()" style="height:30px;">
				...
				<li class="dropdown1">
					<a href=javascript:void(0) class="dropbtn" id="materiB" onclick="dropdown()" style="height:50px;">
				...
				<li class="dropdown1">
					<a href=javascript:void(0) class="dropbtn" id="materiC" onclick="dropdown2()" style="height:50px;">
